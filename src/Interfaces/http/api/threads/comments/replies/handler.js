...
class ThreadCommentReplyHandler {
    ...
    async postThreadCommentReplyHandler(request, h) {
        ...
        const addedReply = await addThreadCommentReplyUseCase.execute({ owner, threadId, commentId, content });
    ...
    async deleteThreadCommentReplyHandler(request, h) {
        ...
        await deleteThreadCommentReplyUseCase.execute({ owner, threadId, commentId, replyId });
