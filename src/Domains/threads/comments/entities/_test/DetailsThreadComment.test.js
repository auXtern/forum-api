...
describe('a DetailsThreadComment entities', () => {
    it('should throw error when payload did not meet data type specification', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadComment(payload)).toThrowError('DETAILS_THREAD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
    ...
    it('should throw error when item in payload array did not contain needed property', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadComment(payload)).toThrowError('DETAIL_THREAD_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY');
    });
    ...
    it('should throw error when item in payload array did not meet data type specification', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadComment(payload)).toThrowError('DETAIL_THREAD_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
