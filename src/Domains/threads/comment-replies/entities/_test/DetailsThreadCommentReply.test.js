...
describe('a DetailsThreadCommentReply entities', () => {
    it('should throw error when payload did not meet data type specification', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadCommentReply(payload)).toThrowError('DETAILS_THREAD_COMMENT_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
    ...
    it('should throw error when item in payload array did not contain needed property', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadCommentReply(payload)).toThrowError('DETAIL_THREAD_COMMENT_REPLY.NOT_CONTAIN_NEEDED_PROPERTY');
    });
    ...
    it('should throw error when item in payload array did not meet data type specification', () => {
        ...
        // Action and Assert
        expect(() => new DetailsThreadCommentReply(payload)).toThrowError('DETAIL_THREAD_COMMENT_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION');
    });
