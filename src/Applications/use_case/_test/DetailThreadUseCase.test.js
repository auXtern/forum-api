...
describe('DetailThreadUseCase', () => {
    ...
    it('should orchestrating the add thread action correctly', async () => {
        ...
        mockThreadCommentRepository.getThreadCommentsByThreadId = jest.fn()
            .mockImplementation(() => Promise.resolve(mockDetailsThreadComment));
        mockThreadCommentReplyRepository.getThreadCommentReplyByCommentId = jest.fn()
            .mockImplementation(() => Promise.resolve(mockDetailsThreadCommentReply));
        ...
        for(let i=0; i<getDetailThread.comments.length; i++){
            ...
            for(let j=0; j<actualComment.replies.length; j++){
                ...
                expect(mockThreadCommentReplyRepository.getThreadCommentReplyByCommentId).toBeCalledWith(actualComment.id);
